...
const TermosDeUso = () => {
  return (
    <div>
      <h2 style={{ color: 'rgb(68, 68, 68)' }}>Política de Privacidade</h2>
      <p style={{ color: 'rgb(68, 68, 68)' }}>
        A sua privacidade é importante para nós. É política do Majil Assessoria respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site{' '}
        <a href="https://MajilAssessoria.com" style={{ color: 'inherit' }}>
          Majil Assessoria
        </a>
      ...
      <p style={{ color: 'rgb(68, 68, 68)' }}>
        ...
        <a href="https://politicaprivacidade.com/" rel="noopener noreferrer" target="_blank" style={{ color: 'inherit' }}>
      ...
      <p style={{ color: 'rgb(68, 68, 68)' }}>
        O uso continuado de nosso site será considerado como aceitação de nossas práticas em torno de privacidade e informações pessoais. Se você tiver alguma dúvida sobre como lidamos com dados do
      ...
      <ul style={{ color: 'rgb(68, 68, 68)' }}>
        ...
        <li>
          ...
          <a href="https://www.google.com/intl/pt-BR_br/policies/privacy/" rel="noopener noreferrer" target="_blank" style={{ color: 'inherit' }}>
            FAQs oficiais sobre privacidade do Google AdSense
          </a>
          .
        </li>
        <li>
          Utilizamos anúncios para compensar os custos de funcionamento deste site e fornecer financiamento para futuros desenvolvimentos. Os cookies de publicidade comportamental usados por este
          site foram projetados para garantir que você forneça os anúncios mais relevantes sempre que possível, rastreando anonimamente seus interesses e apresentando coisas semelhantes que
      ...
      <p style={{ color: 'rgb(68, 68, 68)' }}>
        O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Majil Assessoria oferece no site e com caráter enunciativo, mas não limitativo:
      </p>
      <ul>
        <li>
        ...
        <li>
          B Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, <a href='https://bbebbet.br.com' style={{ color: 'inherit' }}>bbebbet</a> ou azar, qualquer tipo de pornografia
          ilegal, de apologia ao terrorismo ou contra os direitos humanos;
        </li>
        <li>
          C Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Majil Assessoria, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou
          quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
        </li>
      </ul>
      ...
      <p style={{ color: 'rgb(68, 68, 68)' }}>Esta política é efetiva a partir de 31 de janeiro de 2024 13:55.</p>
    </div>
  );
};
